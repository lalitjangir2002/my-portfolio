...
return (
    <div className='home-data'>
        <h1 className="home-title">Lalit Jangir
        <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
        ...
        <p className='home-description'>I am a passionate Computer Science Engineering Student at NIT Agartla and I am enthusiastic about new Tech Skills.</p>
